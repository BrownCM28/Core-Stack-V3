...
export default function WikiIndexPage() {
  ...
  return (
    <div>
      ...
      <p className="font-sans text-[#6B7280] text-lg leading-relaxed mb-10 max-w-xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
        {featured.map((article) => (
          <Link
            ...
            className="block bg-white border border-[#E0E0E0] rounded-xl p-6 hover:border-[#3ECF8E] transition-colors cursor-pointer"
          >
            ...
            <p className="font-sans text-sm text-[#6B7280] leading-relaxed mb-4">
              {article.description}
            </p>
      ...
      <div className="flex flex-col">
        {all.map((article) => (
          <Link
            key={article.slug}
            href={`/wiki/${article.slug}`}
            className="flex items-start gap-4 py-4 border-b border-[#E0E0E0] last:border-0 hover:bg-[#F0F0F0] -mx-4 px-4 rounded transition-colors cursor-pointer"
          >
            <span className="font-mono text-xs bg-[#F0F0F0] text-[#6B7280] px-2 py-0.5 rounded flex-shrink-0 mt-0.5">
              {article.category}
            </span>
            <div className="min-w-0">
              ...
              <p className="font-sans text-sm text-[#6B7280] line-clamp-1">
                {article.description}
              </p>
