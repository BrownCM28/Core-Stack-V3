  ...
  return (
    <div className="bg-surface border-[1.5px] border-[#E2DDD8] rounded-[8px] p-8">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 px-5 py-3 bg-[#24292F] border-[1.5px] border-black text-white font-mono font-semibold text-sm rounded-[6px] hover:bg-[#2f363d] transition-all duration-150 mb-3 shadow-sm disabled:opacity-60 disabled:cursor-not-allowed"
      >
      ...
      <form onSubmit={handleEmailSignUp} className="flex flex-col gap-3">
        ...
        <button
          ...
          className="w-full px-5 py-2.5 bg-accent border-[1.5px] border-black text-[#0D0F12] font-mono font-semibold text-sm rounded-[6px] hover:bg-[#34C47E] hover:shadow-[0_0_16px_rgba(62,207,142,0.25)] transition-all duration-150 mt-1 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
        >
      ...
      <p className="font-sans text-sm text-text-muted text-center mt-5">
      ...
      <p className="font-sans text-[11px] text-text-muted/70 text-center mt-4 leading-relaxed">
        By creating an account you agree to our{" "}
        <Link href="/terms" className="underline hover:text-accent transition-colors">Terms</Link>
        {" "}and{" "}
